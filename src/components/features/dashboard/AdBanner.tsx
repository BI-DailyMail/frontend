  ...
  },
  {
    ...
    banner: (
      <svg viewBox="0 0 320 120" xmlns="http://www.w3.org/2000/svg" className="w-full rounded-lg">
        ...
        {/* 퍼센트 + 라벨 나란히 */}
        <text x="96" y="88" fontFamily="sans-serif" fontSize="20" fontWeight="800" fill="#fb923c">99.2%</text>
        <text x="162" y="88" dominantBaseline="middle" dy="-4" fontFamily="sans-serif" fontSize="11" fill="#fdba74">탐지 정확도</text>
